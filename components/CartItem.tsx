...
const CartItem: React.FC<CartItemProps> = ({ item }) => {
  ...
  return (
    <div className={`p-4 sm:p-6 transition-opacity ${isRemoving ? 'opacity-50' : ''}`}>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center border border-gray-300 rounded-lg">
              <button
                ...
                className="p-3 text-gray-600 hover:text-gray-800 disabled:opacity-50 disabled:cursor-not-allowed touch-manipulation"
              >
              ...
              <input
                ...
                disabled={isUpdating}
                className="w-12 text-center border-0 focus:ring-0 disabled:opacity-50 text-sm font-medium"
              />
